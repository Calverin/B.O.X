...
execute align xyz run summon block_display ~ ~1 ~ {Tags:["scale","dispenser","object","new_dispenser"],block_state:{Name:"minecraft:orange_stained_glass"},brightness:{sky:15,block:15}}
